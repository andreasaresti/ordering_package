        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-dropdown title="Apps" align="right" width="48">
                        ...
                        @endcan
                        @can('view-any', App\Models\ProductVariant::class)
                        <x-dropdown-link href="{{ route('product-variants.index') }}">
                        Product Variants
                        </x-dropdown-link>
                        @endcan
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                ...
                @endcan
                @can('view-any', App\Models\OrderItem::class)
                <x-responsive-nav-link href="{{ route('order-items.index') }}">
                Order Items
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Product::class)
                ...
                @endcan
                @can('view-any', App\Models\ProductVariant::class)
                <x-responsive-nav-link href="{{ route('product-variants.index') }}">
                Product Variants
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\User::class)
